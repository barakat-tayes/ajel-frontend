...
export default function ContactPage() {
  ...
  const whatsappRaw = String(data.contact_whatsapp || "").trim();
  const whatsapp = (() => {
    if (!whatsappRaw) return "";
    if (/^https?:\/\//i.test(whatsappRaw)) return whatsappRaw;
    if (whatsappRaw.startsWith("wa.me/")) return `https://${whatsappRaw}`;
  ...
  return (
    <div
      dir="rtl"
      style={{ minHeight: "100vh", background: "#ffb800", padding: 16 }}
    >
      <div
        style={{
          maxWidth: 900,
      ...
      >
        ...
        <p style={{ color: "#475569", marginTop: 0 }}>
          هذه البيانات تُدار من إعدادات الأدمن وتظهر هنا تلقائيًا.
        </p>
